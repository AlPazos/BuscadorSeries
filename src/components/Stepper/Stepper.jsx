// Stepper de React Bits (reactbits.dev), adaptado a este proyecto:
// - prop completeButtonText: el original ponía "Complete" en duro en el último paso
// - colores con las variables de tema del proyecto (motion sabe resolver var())
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" style={disableStepIndicators ? { pointerEvents: 'none', opacity: 0.5 } : {}} animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: 'var(--code-bg)', color: 'var(--text)' },
          active: { scale: 1, backgroundColor: 'var(--accent)', color: 'var(--accent)' },
          complete: { scale: 1, backgroundColor: 'var(--accent)', color: '#fff' }
        }}
